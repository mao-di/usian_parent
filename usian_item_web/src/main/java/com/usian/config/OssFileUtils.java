...
public class OssFileUtils {
   ...
   private static String accessKeyId = "LTAI4G2i7zEq5cNpgtR7WCm5";

   private static String accessKeySecret = "chEuMKnh7DfZ1piyUzktNkz30YAbXb";

   private static String bucketName = "h2004busian";
