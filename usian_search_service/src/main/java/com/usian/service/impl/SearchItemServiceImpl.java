...
public class SearchItemServiceImpl implements SearchItemService {
    ...
    public int updateDocument(String itemId) throws IOException {
        UpdateRequest updateRequest = new UpdateRequest(ES_INDEX_NAME, ES_TYPE_NAME, itemId);
    ...
    public int deleteDocument(String itemId) throws IOException {
        DeleteRequest deleteRequest = new DeleteRequest(ES_INDEX_NAME, ES_TYPE_NAME, itemId);
